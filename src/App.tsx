...
export default function App() {
  return (
    // FIX 1: Removed overflow-x-hidden from here
    <div className="min-h-screen bg-[#111111] text-[#d4d4d4] font-sans selection:bg-[#4285f4] selection:text-white relative">
      <div
      ...
      <div className="relative z-10 flex flex-col min-h-screen w-full max-w-[1440px] mx-auto">
        ...
        {/* FIX 2: Moved overflow-x-hidden ONLY to the main content tag */}
