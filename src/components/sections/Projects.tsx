      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        ...
        <div className="bg-[#161616] border border-[#222] p-6 sm:p-8 relative overflow-hidden min-w-0">
          ...
          <div className="relative z-10">
            <span className="bg-[#ccc] text-[#111] px-2 py-0.5 text-[8px] font-bold tracking-widest uppercase mb-4 inline-block">ENTERPRISE</span>
        ...
        <div className="bg-[#161616] border border-[#222] p-6 sm:p-8 flex flex-col justify-center min-w-0">
          <div className="text-[#888] text-[9px] font-mono tracking-[0.2em] uppercase mb-8">PROJECT_ACCESS_STATUS</div>
          <div className="bg-[#111] border border-[#333] p-5 sm:p-6 flex flex-col gap-4">
            <div className="text-[#d97757]">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect><path d="M7 11V7a5 5 0 0110 0v4"></path></svg>
            </div>
            <div className="text-[#ccc] text-sm leading-relaxed tracking-wide">
              Independent project. Architecture available for technical discussion. Code available on request — not currently public.
            </div>
          </div>
        </div>
      </div>
